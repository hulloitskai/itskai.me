...
#           T.nilable(T.proc.params(arg: T.untyped).void),
#         ),
...
ActiveRecord::AttributeMethods::PrimaryKey::ClassMethods::ID_ATTRIBUTE_METHODS =
  T.let(T.unsafe(nil), T::Set[T.untyped])

ActiveRecord::AttributeMethods::RESTRICTED_CLASS_METHODS =
  T.let(T.unsafe(nil), T::Array[T.untyped])
...
class ActiveRecord::Base
  ...
  def self.after_commit(*args, if: nil, on: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.after_create(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.after_destroy(*args, if: nil, unless: nil, &block); end
  ...
  def self.after_rollback(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.after_save(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.after_update(*args, if: nil, unless: nil, &block); end
  ...
  def self.after_validation(*args, if: nil, unless: nil, on: nil, &block); end
  ...
  #   ).void
  # end
  # def self.around_create(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.around_destroy(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.around_save(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.around_update(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.before_create(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.before_save(*args, if: nil, unless: nil, &block); end
  ...
  #   ).void
  # end
  # def self.before_update(*args, if: nil, unless: nil, &block); end
  ...
  def self.before_validation(*args, if: nil, unless: nil, on: nil, &block); end
...
module ActiveRecord::Persistence
  ...
  sig do
    params(attribute: T.any(Symbol, String), by: T.nilable(Integer))
      .returns(T.self_type)
  end
  ...
  sig do
    params(options: T.nilable({ lock: T.nilable(T::Boolean) }))
      .returns(T.self_type)
  end
  def reload(options = nil); end

  # sig do
  #   params(args: T.untyped, blk: T.nilable(T.proc.void)).returns(TrueClass)
  # end
  # def save!(*args, &blk); end

  # sig do
  #   params(args: T.untyped, blk: T.nilable(T.proc.void)).returns(T::Boolean)
  # end
  # def save(*args, &blk); end
  ...
  sig do
    params(
        names: T.any(Symbol, String, T::Array[T.any(Symbol, String)]),
        time: T.nilable(Time),
      )
      .returns(T::Boolean)
  end
  ...
  sig do
    params(name: T.any(Symbol, String), value: T.untyped).returns(T::Boolean)
  end
...
module ActiveRecord::Persistence::ClassMethods
  ...
  sig do
    params(id_or_array: T.any(T.untyped, T::Array[T.untyped]))
      .returns(T.untyped)
  end
...
module ActiveRecord
  ...
  class FixtureClassNotFound < ActiveRecordError
  end
...
class ActiveRecord::Schema < ActiveRecord::Migration::Current
  sig do
    params(
      info: T::Hash[T.untyped, T.untyped],
      blk: T.proc.bind(ActiveRecord::Schema).void,
    ).void
  end
...
module ActiveRecord::AttributeMethods::Dirty
  sig do
    params(attr_name: T.any(String, Symbol), options: T.untyped)
      .returns(T::Boolean)
  end
...
#       puts t.class  # => "ActiveRecord::ConnectionAdapters::PostGIS::TableDefinition"
#     end
#   end
#
#   def down
...
class ActiveRecord::ConnectionAdapters::PostGIS::TableDefinition
  ...
  sig do
    params(name: T.any(String, Symbol))
      .returns(ActiveRecord::ConnectionAdapters::ColumnDefinition)
  end
  def [](name); end
  ...
  #     .returns(T.self_type)
  # end
  # def column(name, type, index: nil, default: nil, **options); end
...
class ActiveRecord::ConnectionAdapters::Table
  ...
  # # ```
  # sig do
  #   params(column_name: T.any(String, Symbol), type: Symbol, options: T.untyped)
  #     .void
  # end
  ...
  # ```
  sig do
    params(column_name: T.any(String, Symbol), options: T.untyped)
      .returns(T::Boolean)
  end
  ...
  sig do
    params(
      ...
      new_index_name: T.any(String, Symbol),
    ).void
  end
  ...
  # ```
  sig do
    params(column_name: T.any(String, Symbol), default_or_changes: T.untyped)
      .void
  end
...
class ActiveRecord::Relation
  ...
  # Returns true if there are no records.
  sig do
    params(block: T.nilable(T.proc.params(arg0: Elem).returns(T::Boolean)))
      .returns(T::Boolean)
  end
  def none?(&block); end
...
#           T
#             .proc
#             .params(t: ActiveRecord::ConnectionAdapters::PostGIS::TableDefinition)
#             .void,
#         ),
#     ).void
#   end
...
class ActiveRecord::Migration::Current < ActiveRecord::Migration
  ...
  sig do
    params(
      table_name: T.any(String, Symbol),
      bulk: T::Boolean,
      blk: T.proc.params(t: ActiveRecord::ConnectionAdapters::PostgreSQL::Table).void,
    ).void
  end
...
#   def connected_to(
#     database: T.unsafe(nil),
#     role: T.unsafe(nil),
#     prevent_writes: T.unsafe(nil),
#     &blk
#   ); end
