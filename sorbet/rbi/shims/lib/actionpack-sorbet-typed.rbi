...
ActionController::Renderer::DEFAULTS =
  T.let(T.unsafe(nil), T::Hash[T.untyped, T.untyped])
...
ActionController::RespondToMismatchError::DEFAULT_MESSAGE =
  T.let(T.unsafe(nil), String)

ActionController::SessionOverflowError::DEFAULT_MESSAGE =
  T.let(T.unsafe(nil), String)
...
#   T.let(T.unsafe(nil), ActionDispatch::Response::ContentTypeHeader)
...
ActionDispatch::Http::ContentDisposition::TRADITIONAL_ESCAPED_CHAR =
  T.let(T.unsafe(nil), Regexp)

ActionDispatch::Http::FilterParameters::ENV_MATCH =
  T.let(T.unsafe(nil), T::Array[T.untyped])

ActionDispatch::Http::FilterParameters::KV_RE = T.let(T.unsafe(nil), String)

ActionDispatch::Http::FilterParameters::NULL_ENV_FILTER =
  T.let(T.unsafe(nil), ActiveSupport::ParameterFilter)

ActionDispatch::Http::FilterParameters::NULL_PARAM_FILTER =
  T.let(T.unsafe(nil), ActiveSupport::ParameterFilter)
...
module ActionDispatch::Routing::Mapper::Resources
  ...
  # sig do
  #   params(path: T.nilable(String), to: T.untyped, as: T.nilable(Symbol))
  #     .returns(T.untyped)
  # end
